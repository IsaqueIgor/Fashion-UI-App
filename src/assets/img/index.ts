...
export {default as People3} from './peoples/slide_3.png';
export {default as People4} from './peoples/slide_4.png';

export {default as Pattern1} from './patterns/bg_pattern_1.png';
export {default as Pattern2} from './patterns/bg_pattern_2.png';
